  ...
  <div class="feature">
    <v-container>
      <v-row>
        <v-col cols="4">
          <div
            class="parent d-flex align-center justify-center text-h5 py-4"
            style="gap: 10px"
          >
            <svg
              style="width: 50px"
        ...
        <v-col cols="4">
          <div
            class="parent d-flex align-center justify-center text-h5 py-4 secand"
            style="gap: 10px"
          >
            <svg
              style="width: 40px"
            ...
            <span>Lowest Price Guaurntee</span>
          </div>
        </v-col>
        <v-col cols="4">
          <div
