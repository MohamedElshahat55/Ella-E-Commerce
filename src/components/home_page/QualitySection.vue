<template>
  <div class="quality py-10">
    <v-container fluid>
      <v-row>
        <v-col v-for="qIcon in qualityIcons" :key="qIcon.tiltle">
          <div class="parent text-center h-100 elevation-4 py-7 rounded-xl">
            <v-card class="h-100" elevation="0">
              <v-card-item class="py-3">
                <span v-html="qIcon.icon" class="d-block"></span>
                <v-card-title class="text-h6 font-weight-bold py-5">{{
                  qIcon.tiltle
                }}</v-card-title>
                <v-card-text class="text-subtitle-2 py-4">{{
                  qIcon.desc
                }}</v-card-text>
              </v-card-item>
            </v-card>
