      ...
      <v-row>
        <v-col cols="7">
          ...
          >
            ...
            <v-card-title class="font-weight-bold text-subtitle-2 px-0 py-4"
            ...
            <div
              class="text-names d-flex justify-space-between py-4"
              style="gap: 10px"
            >
              <input
                type="text"
                class="pa-3 rounded-lg"
                style="border: 1px solid rgb(237, 237, 237); width: 100%"
            ...
            />
            <div
              class="text-city d-flex justify-center aligh-center py-4"
              style="gap: 10px"
            >
              <input
                type="text"
            ...
            <v-divider length="100%" color="black"></v-divider>
            <v-card-text style="color: rgb(170, 170, 170); font-size: 12px"
        ...
        <v-col cols="5">
          ...
          >
            <v-row v-for="product in cartItems" :key="product.id">
              <v-col cols="2"
              ...
              <v-col cols="8">
                <p class="mt-6 font-weight-bold text-subtitle-2">
            ...
            <v-row>
              <v-col cols="12" class="px-6">
                <div
                  class="discount d-flex justify-center align-center"
                  style="gap: 20px"
                >
                  <input
                    type="text"
                    class="pa-3 rounded-lg w-100"
                    style="border: 1px solid rgb(198, 198, 198); height: 50px"
              ...
              <v-row class="mt-4">
                <v-col cols="12">
                  <v-card-text
                    class="d-flex justify-space-between aligh-center px-6 py-0"
                  >
                    <span>Subtotal</span>
                ...
                <v-col cols="12">
                  ...
                  >
                    ...
                    <p>
                      <span style="font-size: 12px; color: rgb(163, 163, 163)"
                        >USD</span
                      ><span class="font-weight-bold"
                        >$ {{ calcTotalPrice + 20 }}.00</span
                      >
                    </p>
                  </v-card-text>
                </v-col>
